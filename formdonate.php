...
<body>
    ...
    <header id="header" class="fixed-top header-inner-pages">
        <div class="container d-flex align-items-center justify-content-between">
            ...
            <h1 class="logo"><img src="./assets/img/logo.png"> &ensp;<a href="index.html"><span class="notranslate">Dian Mandiri</span></a></h1>
            <h3><span class="notranslate">Dian Mandiri</span></h3>
                    ...
                    <div class="col-lg-12 entries">
                        ...
                        <article class="entry">
                            ...
                            <h2 class="entry-title">
                                <a>Giving is an act of supporting</a>
                            </h2>
                            ...
                            <div class="entry-content">
                                <h3><strong>Donate By Transfer Bank</strong></h3>
                                <p> <i>
                                    ...
                                    <br>
                                    <i>
                                        Bank Address:</i> <br> Komp, Jl. Taman Ratu Raya BI. BI No.5/8, RT.1/RW.5, Duri Kepa, Jakarta, Kota Jakarta Barat, Daerah Khusus Ibukota Jakarta 11510
                                    <br>
                                    <i>
                                        Branch:</i> <br> BCA KCP Taman Ratu
                                    <br>
                                </p>
